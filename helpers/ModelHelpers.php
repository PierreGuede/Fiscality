...
namespace App\Fiscality\AdvertisingGifts{
     ...
     *
     * @property int $id
     * @property float $reintegrate_excedent
     * @property float $deduction_limite
     ...
     * @method static \Illuminate\Database\Eloquent\Builder|AdvertisingGift whereDeductionLimite($value)
     * @method static \Illuminate\Database\Eloquent\Builder|AdvertisingGift whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder|AdvertisingGift whereReintegrateExcedent($value)
...
namespace App\Models{
     ...
     * @method static \Illuminate\Database\Eloquent\Builder|DonationGrantContribution whereTotalAmount($value)
...
namespace App\Models{
     ...
     * @property string $name
     * @property string $amount
     * @property int $state_donation_id
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property int $company_id
     ...
     * @method static \Illuminate\Database\Eloquent\Builder|StateDonationDetail whereStateDonationId($value)
