            ...
            <div class="overflow-x-auto w-full">
                <table class="w-full whitespace-no-wrap">
                    ...
                    <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase bg-gray-50 border-b">
                        ...
                        <th class="px-4 py-3">entreprises de fonction</th>
                    </tr>
                    </thead>
                    ...
                    @foreach($users as $user)
                        <tr class="text-gray-700">
                            ...
                            <td class="px-4 py-3 text-sm">
                                @foreach ($user->roles  as $items)
                                {{ $items->name}}
                                @endforeach
                            </td>
                            <td class="px-4 py-3 text-sm">
                                @foreach ($user->personnel  as $personnel)
                ...
                <div class="bg-white w-11/12 md:max-w-md mx-auto rounded shadow-lg py-4 text-left px-6" x-show="showModal" @click.away="showModal = false" >
                    ...
                    <div class="mt-4">
                        ...
                        <div class="mt-4">
                            ...
                            <select multiple class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50 focus-within:text-primary-600" name="company_id" >
