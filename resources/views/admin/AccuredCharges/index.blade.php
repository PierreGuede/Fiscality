<x-admin-space-layout>
    ...
    <div class="p-4 rounded-lg shadow-xs">        <div class="flex p-2">
        ...
        <div class="text-right w-1/5">
            <x-form.button icon="plus-sm" primary class="" href="{{ route('accured-charges.create') }}">Ajouter</x-form.button>
        </div>
    ...
    <table class="p-2 w-full text-sm text-left text-gray-500    ">
        ...
        <tbody>
            @foreach ($accuredCharge as $accuredCharge)
                <tr class="bg-white border-b      ">
                    <th scope="row" class="px-6 py-4 font-medium text-gray-900    whitespace-nowrap">
                        {{ $accuredCharge->compte }}
                    </th>
                    <th scope="row" class="px-6 py-4 font-medium text-gray-900    whitespace-nowrap">
                        {{ $accuredCharge->designation }}
                    </th>

                    <th scope="row"
                        class="flex space-x-4 px-6 py-4 font-medium text-gray-900    whitespace-nowrap">
                        <a href="{{ route('accured-charges.edit', $accuredCharge->id) }}" class="text-blue-800">Editer</a>
