        ...
        <div class="flex p-2">
            ...
            <div class="w-1/5 items-center text-center">
                <button type="button"
                    ...
                    @click="showModal = true">Creer un produit/charge</button>
            </div>
        </div>
                                    ...
                                    <div class="bg-white w-11/12 md:max-w-md mx-auto rounded shadow-lg py-4 text-left px-6"
                                        ...
                                        <div class=" pb-3">
                                            ...
                                            <div class="flex space-x-2 mt-4 text-center mx-auto w-10/12">
                                                ...
                                                <div class="w-1/2">
                                                    <form
                                                        action="{{ route('accounting-product.delete', $productCountable->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('delete')
                                                        <button type="submit"
        ...
        <div class="overflow-auto" style="background-color: rgba(0,0,0,0.5)" x-show="showModal"
            ...
            <div class="bg-white w-11/12 md:max-w-md mx-auto rounded shadow-lg py-4 text-left px-6" x-show="showModal"
                ...
                <form action="{{ route('accounting-product.store') }}" method="POST" class="space-y-4 p-4">
                    ...
                    <input type="text" name="account" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm"
