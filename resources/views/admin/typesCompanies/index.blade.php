    ...
    <div class="p-4 bg-white rounded-lg shadow-xs">
        <div class="flex p-2">
            ...
            <div class="w-1/5 items-center text-center">
                <button type="button" class="bg-green-500 border border-gray-500 text-white font-bold py-2 px-4 rounded-md" @click="showModal = true">Creer un type de compagnie</button>
            </div>
        </div>
                                    ...
                                    <div class="bg-white w-11/12 md:max-w-md mx-auto rounded shadow-lg py-4 text-left px-6" x-show="showModalConfirm" @click.away="showModalConfirm = false" >
                                        <div class=" pb-3">
                                            ...
                                            <div class="flex space-x-2 mt-4 text-center mx-auto w-10/12">
                                                ...
                                                <div class="w-1/2">
                                                    <form action="{{ route('typeImpot.delete',$type->id) }}" method="POST">
                                                        @csrf
                                                        @method('delete')
			...
			<div class="bg-white w-11/12 md:max-w-md mx-auto rounded shadow-lg py-4 text-left px-6" x-show="showModal" @click.away="showModal = false" >
                ...
                <form action="{{ route('type.store') }}" method="POST" class="space-y-4 p-4">
                    ...
                    <div class="mt-4">
                        ...
                        <select class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50 focus-within:text-primary-600" name="impot_id">
