<x-app-layout>
        ...
        <div class="flex p-2">
            ...
            <div class="w-1/5 items-center text-center">
                <button type="button"
                    ...
                    @click="showModal = true">Creer une sous catégorie</button>
            </div>
        </div>
    ...
    <div class="p-4 bg-white rounded-lg shadow-xs">
        ...
        <form action="{{ route('category.update', $category->id) }}" method="POST" class="space-y-4">
            ...
            <button type="submit"
                class="px-4 py-2 text-sm font-medium leading-5 text-center text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring">Modifier</button>
        </form>
    ...
    <section class="flex flex-wrap p-4 h-full items-center">
        ...
        <div class="overflow-auto" style="background-color: rgba(0,0,0,0.5)" x-show="showModal"
            ...
            <div class="bg-white w-11/12 md:max-w-md mx-auto rounded shadow-lg py-4 text-left px-6" x-show="showModal"
                ...
                <!-- content -->
                <form action="{{ route('category.affect', $category->id) }}" method="POST" class="space-y-4 p-4">
                    @csrf
                ...
                <div class="flex justify-end pt-2">
                    <button
                        ...
                        @click="alert('Pour votre Entreprise vous pouvez ajouter des types de personnes qui y travaillent');">Info</button>
