<x-company-layout :company="$company" >
    ...
    <div class="w-full  min-h-screen" >
        ...
        <x-title>Charges provisionnées</x-title>
                    ...
                    <tr class="w-full shadow-lg shadow-blue-200 border-b-4 border-blue-200 bg-white">
                        ...
                        <td class="text-center text-xs font-semibold py-4 px-4  my-10">
                            <div class="flex space-x-4">
                                <a href="{{ route('tax-result.reintegration.accured-charge.detailExpenseProvisioned.edit',['company'=>$company->id,'expense'=>$value->id]) }}">
