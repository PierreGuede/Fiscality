<x-company-layout :company="$company" >
    ...
    <div class="w-full  min-h-screen" >
        ...
        <div class="max-w-5xl w-full mx-auto">
            <form method="POST" class="space-y-4" action="{{ route('tax-result.reintegration.accured-charge.detailProvision.update',['company'=>$company->id,'provision'=>$provision->id]) }}">
                @method('PUT')
                @csrf
                <div>
