<x-company-layout>
<div class="max-w-5xl w-full mx-auto pt-12 " >
    ...
    <div class=" grid grid-cols-12 divide-x-2 divide-blue-500 border-2 border-blue-500 ">
        ...
        <div class="col-span-4 ">
            <x-input  type="text" label="" id="username" name="username"
                      value="{{ old('username') }}" class="w-full mt" required autofocus />
        </div>
        <div class="col-span-2">
    ...
    <div class=" grid grid-cols-12 divide-x-2 divide-blue-500 border-2 border-blue-500 ">
        ...
        <div class="col-span-2">
            <button  class="w-full text-sm  flex  items-center justify-center px-4 py-2 text-blue-50 bg-blue-500 hover:bg-blue-400 gap-x-2 font-semibold" >
