<x-app-layout>
    ...
    <div class="p-4 bg-white rounded-lg shadow-xs">
            ...
            <form action="{{ route('base.update',$base->id) }}" method="POST" class="space-y-4">
                @csrf
                <input type="text" name="name" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm " value="{{ old('name',$base->name) }}">
