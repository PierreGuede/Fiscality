    ...
    <div class="p-4 bg-white rounded-lg shadow-xs">
        <div class="flex p-2">
            ...
            <div class="w-1/5 items-center text-center">
                <button type="button" class="bg-green-500 border border-gray-500 text-white font-bold py-2 px-4 rounded-md" @click="showModal = true">Creer un Type</button>
            </div>
        </div>
                ...
                <form action="{{ route('subCategory.store') }}" method="POST" class="space-y-4 p-4">
                    ...
                    <div class="flex space-x-2">
                        <div class="w-1/2">
                            ...
                            <input type="text" name="name" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm" placeholder="Nom">
                        </div>
                        <div class="w-1/2">
                           </div>
                    </div>
                    <div class="flex space-x-2">
                        <div class="w-1/2">
                            ...
                            <input type="text" name="taux" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm" placeholder="Taux">
                        </div>
                        <div class="w-1/2">
                            <x-label :value="__('Description')"/>
                            <input type="text" name="description" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm" placeholder="Description">
                        </div>
                    </div>
                    <div class="flex space-x-2">
                        <div class="w-1/2">
                            <x-label :value="__('Article')"/>
                            <input type="text" name="article" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm" placeholder="Article">
                        </div>
                        <div class="w-1/2">
                            <x-label :value="__('Categorie')"/>
                            <select name="category_id" id=""  class="block w-full mt-1 border-gray-300 rounded-md shadow-sm">
                    ...
                    <div class="flex space-x-2">
                        <div class="w-1/2">
                            ...
                            <select name="base_id" id=""  class="block w-full mt-1 border-gray-300 rounded-md shadow-sm">
                        ...
                        <div class="w-1/2">
                            ...
                            <select name="type_impot_id" id=""  class="block w-full mt-1 border-gray-300 rounded-md shadow-sm">
