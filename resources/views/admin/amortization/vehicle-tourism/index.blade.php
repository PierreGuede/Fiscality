        ...
        <x-title>Vehicule de tourismes</x-title>
            ...
            <table class="w-full" >
                <thead class="bg-transparent uppercase py-2 text-gray-600" >
                    ...
                    <th class="text-xs py-3.5 font-semibold" >Véhicule</th>
                    <th class="text-xs py-3.5 font-semibold" >Valeur d'origine</th>
                    <th class="text-xs py-3.5 font-semibold" >Plafond</th>
                    ...
                    <tr class="w-full shadow-lg shadow-blue-200 border-b-4 border-blue-200 bg-white">
                        ...
                        <td class="text-center text-xs font-semibold py-4 px-4  my-10">
                            <div class="flex space-x-4">
                                ...
                                <svg onclick="Livewire.emit('openModal', 'company.amortization.delete-vehicle-handler', {{ json_encode([ $value->id]) }})"  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 text-red-600 cursor-pointer">
