                    ...
                    <tr class="w-full shadow-lg shadow-blue-200 border-b-4 border-blue-200 bg-white">
                        ...
                        <td class="text-center text-xs font-semibold py-4 px-4  my-10">
                            <div class="flex space-x-4">
                                ...
                                <svg onclick="Livewire.emit('openModal', 'company.amortization.delete-depreciation-handler', {{ json_encode([ $value->id]) }})"  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 text-red-600 cursor-pointer">
