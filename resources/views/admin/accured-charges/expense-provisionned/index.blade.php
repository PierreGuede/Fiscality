<x-company-layout :company="$company">
    <div class="w-full  min-h-screen" >
        <div class="max-w-5xl w-full mx-auto">
            <h5 class="text-lg font-semibold text-gray-500 py-5 " >Charges provisionnées</h5>
            <table class="w-full" >
                    ...
                    @foreach($accuredChargeCompany as $key => $value)
                        ...
                        <td class="text-center text-xs font-semibold py-4 px-4  my-10">
                            <div class="flex space-x-4">
                                <a href="{{ route('work.expenseProvisioned.edit',['company'=>$company->id,'accuredChargeCompany'=>$value->id]) }}">
