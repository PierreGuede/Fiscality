<x-company-layout :company="$company">
    <div class="w-full  min-h-screen" >
        <div class="max-w-5xl w-full mx-auto">
            <h5 class="text-lg font-semibold text-gray-500 py-5 " >Provisions pour risque d'exploitation</h5>
            <table class="w-full" >
                ...
                <tbody>
                @foreach($accuredChargeCompany as $key => $value)
                    <tr class="w-full shadow-lg shadow-blue-200 border-b-4 border-blue-200 bg-white">
                        <td class=" text-center text-xs font-semibold py-4 px-4  my-10" >{{ $value->compte  }}</td>
                        ...
                        <td class="text-center text-xs font-semibold py-4 px-4  my-10">
                            <div class="flex space-x-4">
                                <a href="{{ route('work.provision.edit',['company'=>$company->id,'accuredChargeCompany'=>$value->id]) }}">
