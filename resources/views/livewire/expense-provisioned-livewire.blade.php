<div class="py-10 px-10 w-full " >
    <div>
        <h5 class="text-base text-gray-600 font-semibold" >Charges provisionnées</h5>
    </div>
            ...
            @foreach ($inputs as $key => $input)
                <div>
                    <div class="flex gap-x-4 ">
                        <div class="w-12">
                            <x-input :disabled="count($charges) > $key" class="w-full" for="input_{{ $key }}_compte"
                        ...
                        <div class="flex-1 w-full">
                            <x-input :disabled="count($charges) > $key" for="input_{{ $key }}_designation"
