        ...
        <div x-data="{ reversals_provisions: {{ $reversals_provisions  }}, capital_gain: {{  $capital_gain }},  currency_transaction_change: {{  $currency_transaction_change }} } " class="space-y-4  mt-8">
            ...
            <div class=" grid grid-cols-12 space-x-4   ">
                ...
                <div class="col-span-4 ">
                    <x-input :disabled="true" step="any" type="number" label="" id="reversals_provisions" name="reversals_provisions"
...
{{--                        <svg class="  stroke-2  w-6 w-6 stroke-blue-500 "--}}
...
{{--                    </button>--}}
            ...
            <div class=" grid grid-cols-12 space-x-4   ">
                ...
                <div class="col-span-4 ">
                    <x-input :disabled="true" step="any" type="number" label="" id="capital_gain" name="capital_gain"
