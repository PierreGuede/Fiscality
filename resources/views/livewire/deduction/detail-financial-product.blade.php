<div
    ...
    <button wire:click="closeASide"
            class="absolute focus:outline-none focus:ring-blue-300 focus:ring-2 focus:ring-offset-1 group top-2 -translate-x-full  left-[calc(50%-0.2rem)] bg-white rounded-full p-2 z-50 ">
    ...
    <div  x-data="{  product_net_ircm_amount: {{  $product_net_ircm_amount }}, product_rate: {{ $product_rate  }}, other_net_ircm_amount: {{ $other_net_ircm_amount  }}, other_rate: {{ $other_rate  }}    } "  class="relative overflow-y-auto w-1/2 bg-white h-full ml-auto  px-12">
