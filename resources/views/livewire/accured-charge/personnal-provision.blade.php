<div class=" flex max-w-4xl bg-white w-full  rounded mt-4" >
    ...
    <div class="w-full p-8 border-r-2 border-blue-500 " >
        <h4 class="text-lg font-semibold text-gray-700 mb-4" > Charges personnel </h4>
        <p class=" text-sm " >
...
{{--            @if(is_null($total))--}}
                <a href="{{ route('work.personalExpense',$company->id) }}" class="w-full focus:outline-none text-sm border-b-2 border-blue-50 flex  items-center justify-center px-4 py-2 text-blue-50 bg-blue-500 hover:bg-blue-400 gap-x-2 font-semibold" >
...
{{--            @endif--}}
            ...
            <a href="{{ route('work.personnalExpense.details', $company->id)  }}" class=" group w-full flex text-sm  items-center justify-center px-4 py-2 text-blue-500 bg-blue-100 hover:bg-blue-500 hover:text-blue-50 gap-x-2 font-semibold" >
