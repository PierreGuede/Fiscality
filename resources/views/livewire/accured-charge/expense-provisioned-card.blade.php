...
{{--            @endif--}}
            ...
            <a href="{{ route('work.expenseProvisioned.details', $company->id)  }}" class=" group w-full flex text-sm  items-center justify-center px-4 py-2 text-blue-500 bg-blue-100 hover:bg-blue-500 hover:text-blue-50 gap-x-2 font-semibold" >
