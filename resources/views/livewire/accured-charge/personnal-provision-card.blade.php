<div class=" flex max-w-4xl bg-white w-full  rounded mt-4" >
    ...
    <div class="w-full p-8 border-r-2 border-blue-500 " >
        <h4 class="text-lg font-semibold text-gray-700 mb-4" > Provisions sur charges de` personnel </h4>
        <p class=" text-sm " >
    ...
    <div class="w-52 text-center flex flex-col justify-between " >
        ...
        <div class="mt-auto ">
            ...
            @if(is_null($total))
                <button onclick="Livewire.emit('openModal', 'accured-charge.create-personnal-provision-handler')" class="w-full focus:outline-none text-sm border-b-2 border-blue-50 flex  items-center justify-center px-4 py-2 text-blue-50 bg-blue-500 hover:bg-blue-400 gap-x-2 font-semibold" >
