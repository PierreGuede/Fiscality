                    ...
                    <div class="flex gap-x-2 items-center ">
                        <div class="grid grid-cols-12 gap-x-2">
                            <div class="col-span-1">
                                <x-input :disabled="true" class="w-full" for="input_{{ $key }}_Account"
                            ...
                            <div class="col-span-3">
                                <x-input :disabled="true" class="w-full" for="input_{{ $key }}_designation"
                            ...
                            <div class="col-span-2">
                                <x-input :disabled="true" class="w-full" for="input_{{ $key }}_total"
                            ...
                            <div class="col-span-2">
                                <x-input :disabled="true" class="w-full" for="input_{{ $key }}_amount_commission"
