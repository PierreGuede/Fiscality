<div
    ...
    <div x-data="{ rent_amount: {{ $rent_amount  }} , rental_period_year: {{ $rental_period_year  }}, annual_deduction_limit: {{ $annual_deduction_limit  }} }"
        ...
        <form>
            ...
            <div class="mt-2 space-y-3 ">
                <x-input :disabled="true"  type="number" label="Montant des loyers(Véhicule de tourisme)" step="any" id="delay_condition" name=""
                         wire:model.defer="rent_amount"  x-model="rent_amount"
                         value="{{ old('delay_condition') }}" class="block w-full" required autofocus/>
                <x-input :disabled="true"  type="number" label="Durée de location au titre de l'annnée (en jour)" step="any" id="delay_condition" name=""
                         wire:model.defer="rental_period_year"  x-model="rental_period_year"
                         value="{{ old('delay_condition') }}" class="block w-full" required autofocus/>
                <x-input :disabled="true"  type="number" label="Limite de déduction" step="any" id="delay_condition" name=""
