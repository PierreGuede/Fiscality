<div
    ...
    <div x-data="{ lib_condition_response: 'yes', delay_condition_response: 'yes' }"
        ...
        <h2 class="text-2xl font-bold text-gray-7002 py-8">DONS à l'Etat</h2>
        ...
        <form class="">
            <div class=" ml-6 mt-4 space-y-4 ">
                ...
                <div class=" space-y-3" >
                    ...
                    @foreach($first_inputs as  $key => $value)
            ...
            <div class="mt-2 space-y-3 ">
                <x-input type="number" label="Totatl dons à l'Etat ou ses démenbrements" id="delay_condition" name=""
                         value="{{ old('delay_condition') }}" class="block w-full" required autofocus/>
                <x-input type="number" label="Excedent des dons à l'Etat" id="delay_condition" name=""
                         value="{{ old('delay_condition') }}" class="block w-full" required autofocus/>
            </div>
...
{{--            CADRE GENERAL--}}
            ...
            <div class=" mt-6" >
                <h5 class="text-xl font-semibold text-gray-700" >Cadre général</h5>
                <div class="mt-2 space-y-3 ">
                    <x-input type="number" label="Chiffre d'affaire" id="delay_condition" name=""
                             value="{{ old('delay_condition') }}" class="block w-full" required autofocus/>
                    <x-input type="number" label="Millième du Chiffre d'affaires" id="delay_condition" name=""
                             value="{{ old('delay_condition') }}" class="block w-full" required autofocus/>
                </div>
            </div>
...
{{--            Dons & Libéralités--}}
            ...
            @foreach($second_inputs as  $key => $value)
                    <div class="flex gap-x-2 items-center ">
