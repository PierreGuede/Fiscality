<div class=" flex max-w-4xl bg-white w-full  rounded mt-4" >
    ...
    <div class="w-full p-8 border-r-2 border-blue-500 " >
        <h4 class="text-lg font-semibold text-gray-700 mb-4" > Surplus d'amortissement {{ $counter  }} </h4>
        <p class=" text-sm " >
    ...
    <div class="w-52 text-center flex flex-col justify-between " >
        ...
        <div class="mt-auto ">
            ...
            <button  class=" group w-full flex text-sm  items-center justify-center px-4 py-2 text-blue-500 bg-blue-100 hover:bg-blue-500 hover:text-blue-50 gap-x-2 font-semibold" >
