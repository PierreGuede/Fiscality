<div x-data="{ total_income: [] }" class="py-10 px-10 w-full " >
    <div class="flex justify-between" >
        ...
        @if(\App\Models\GuruMinimumTax::COLLECTABLE_PRODUCT == $guruMinimumTax[0]->type)
            <h5 class="text-base text-gray-600 font-semibold" >Produits encaissables</h5>
        @else
            <h5 class="text-base text-gray-600 font-semibold" >Distributeurs de produits pétroliers et stations service </h5>
        @endif
            ...
            @foreach ($inputs as $key => $input)
                <div>
                    <div class="flex gap-x-4 ">
                        <div class="w-12">
                            <x-input :disabled="count($guruMinimumTax) > $key"
                        ...
                        <div class="flex-1 w-full">
                            <x-input :disabled="count($guruMinimumTax) > $key" for="input_{{ $key }}_name"
