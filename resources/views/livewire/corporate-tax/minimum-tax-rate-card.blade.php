<div class=" flex max-w-4xl bg-white w-full  rounded mt-4">
    ...
    <div class="w-full p-8 border-r-2 border-blue-500 ">
        <h4 class="text-lg font-semibold text-gray-700 mb-4"> Impôt Minimum forfétaire </h4>
        <p class=" text-sm ">
...
{{--            @if($total_vehicle > 0)--}}
{{--                <button--}}
{{--                    onclick="Livewire.emit('openModal', 'corporate-tax.create-real-tax', {{ json_encode([ "company" => $company ]) }})"--}}
