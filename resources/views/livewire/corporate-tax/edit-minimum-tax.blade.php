<div x-data="{ total_income: [] }" class="py-10 px-10 w-full " >
    <div class="flex justify-between" >
        ...
        @if(\App\Models\GuruMinimumTax::COLLECTABLE_PRODUCT == $minimumDetail[0]->type)
            ...
            @foreach ($inputs as $key => $input)
                <div>
                    <div class="flex gap-x-4 ">
                        <div class="w-12">
                            <x-input :disabled="count($minimumDetail) > $key"
                        ...
                        <div class="flex-1 w-full">
                            <x-input :disabled="count($minimumDetail) > $key" for="input_{{ $key }}_name"
