...
<a :class="{ 'bg-cyan-700': {{ $active  }} }"   :class="!openSidebar && 'justify-center'" {{ $attributes->merge(['class' => 'group relative mt-2 flex h-8 w-full items-center rounded px-3 hover:bg-cyan-700']) }} >
