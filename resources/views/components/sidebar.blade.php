...
<div x-data="{ openSidebar: true }" :class=" openSidebar ? 'w-56' : 'w-20'  "  class=" relative flex transition-all h-full flex-col items-center   bg-blue-600 text-blue-100">
...
{{--            </a>--}}
            ...
            <div x-data="{ expanded: false }" :class=" expanded || {{ request()->routeIs('tax-result.*')  }} ? 'bg-blue-700 nav--link__collapse' : ' bg-none '"  class="p-2  rounded-md w-full text-sm  mt-4" x-cloak  >
                <a href=" {{ route('tax-result.account-result', $company->id)  }}" @click="expanded = !expanded"  type="button" class="mt-2 flex h-12 w-full items-center rounded px-3  focus:outline-none hover:bg-blue-500 gap-x-2" >
                ...
                <div x-show=" {{ request()->routeIs('tax-result.*')  }} " class="ml-4   " x-collapse >
                    ...
                    <a href=" {{ route('tax-result.non-deductible-charge', $company->id)  }}" :class=" {{ request()->routeIs('tax-result.non-deductible-charge')  }} ? 'bg-blue-500' :''  "  class="mt-2 flex h-10 w-full items-center rounded px-3 hover:bg-blue-500 gap-x-2" >
                        <svg class="h-4 w-4  stroke-current shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">--}}
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                        </svg>
            ...
            <a href="{{ route('amortization',$company->id) }}"   :class="!openSidebar && 'justify-center'" class=" group relative mt-2 flex h-12 w-full items-center rounded px-3 hover:bg-blue-700" href="#">
                <svg class="h-6 w-6 stroke-current shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                </svg>
                <span x-show="openSidebar" class="ml-2 text-sm font-medium transition-all line-clamp-1 ">Amortissement</span>
            ...
            <a href="{{ route('work.accuredCharge',$company->id) }}"   :class="!openSidebar && 'justify-center'" class=" group relative mt-2 flex h-12 w-full items-center rounded px-3 hover:bg-blue-700" href="#">
                <svg class="h-6 w-6 stroke-current shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                </svg>
                <span x-show="openSidebar" class="ml-2 text-sm font-medium transition-all line-clamp-1 ">Provisions et charges provisionnées</span>

                <div class="absolute scale-0 group-hover:scale-100 transition-all duration-300 -right-full translate-x-8 w-full bg-gray-700 text-white text-sm py-1.5 px-2.5 rounded-md " >
                    <div class="relative " >

                    <p>Provisions et charges provisionnées</p>
