...
})->middleware(['auth', 'two-factor', 'hasOneRole', 'email_verified'])->name('dashboard');
...
//    });
    ...
    //        Route::get('workspace/company/{company}/account-result', [\App\Http\Controllers\WorkInEnterprise::class, 'accountResult'])->name('work.accountResult');
            ...
            Route::put('workspace/company/{company}/accured-charge/detail-provision/{provision}', [\App\Http\Controllers\AccuredChargeController::class, 'update'])->name('tax-result.reintegration.accured-charge.detailProvision.updateProvision');
            ...
            Route::put('workspace/company/{company}/accured-charge/detail-expense-provisioned/{expense}', [\App\Http\Controllers\AccuredChargeController::class, 'update'])->name('tax-result.reintegration.accured-charge.detailExpenseProvisioned.updateExpenseProvisionned');
            ...
            Route::put('workspace/company/{company}/accured-charge/detail-personal-provision/{personnalProvision}', [\App\Http\Controllers\AccuredChargeController::class, 'update'])->name('tax-result.reintegration.accured-charge.detailPersonalProvision.updatePersonnalProvision');
...
Route::middleware('auth', 'role:Super-Admin|cabinet|enterprise')->group(function () {
    Route::get('company/{company}', [\App\Http\Controllers\CompanyController::class, 'edit'])->name('company.edit');
...
Route::middleware('auth', 'role:Super-Admin')->group(function () {
    ...
    Route::get('domain/create', [\App\Http\Controllers\DomainController::class, 'create'])->name('domain.create');
    ...
    Route::get('base/create', [\App\Http\Controllers\BaseController::class, 'create'])->name('base.create');
    ...
    Route::get('pack/create', [\App\Http\Controllers\PackController::class, 'create'])->name('pack.create');
    ...
    Route::get('taxCenter/create', [\App\Http\Controllers\TaxCenterController::class, 'create'])->name('taxCenter.create');
    ...
    Route::get('principalActivity/create', [\App\Http\Controllers\PrincipalActivityController::class, 'create'])->name('typeAct.create');
    ...
    Route::get('type-impot/create', [\App\Http\Controllers\TypeImpotController::class, 'create'])->name('typeImpot.create');
    ...
    Route::get('type_company/create', [\App\Http\Controllers\TypeCompanyController::class, 'create'])->name('type.create');
