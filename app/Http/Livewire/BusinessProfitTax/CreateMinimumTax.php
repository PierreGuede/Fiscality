...
class CreateMinimumTax extends ModalComponent
{
    ...
    {
        return view('livewire.business-profit-tax.create-minimum-tax');
    }
    ...
    public function getCompanyMinimumTax()
    {
        ...
        $this->guruMinimumTax = GuruMinimumTax::whereType($this->base->code == Base::PRODUIT_ENCAISSABLE ? GuruMinimumTax::COLLECTABLE_PRODUCT : GuruMinimumTax::VOLUME)->whereTypeImpotId($iba->id)->get();
    }
