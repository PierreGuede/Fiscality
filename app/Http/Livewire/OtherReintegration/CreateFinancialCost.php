...
class CreateFinancialCost extends Component
{
    ...
    public function store()
    {
        ...
        $financialCost=FinancialCost::create([
            ...
            'total_amount_reintegrated'=>array_sum(array ( $reintegrate_amount ? $reintegrate_amount < 0 : 0 , max(array($amount_reintegrated,$this->lib_condition,$this->delay_condition)))),
            'condition_amount_reintegrated'=>$reintegrate_amount ? $reintegrate_amount < 0 : 0,
            'interest_amount_reintegrated'=>max(array($amount_reintegrated,$this->lib_condition,$this->delay_condition)),
            'date'=>date('Y'),
